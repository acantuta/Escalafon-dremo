...
use App\Models\Escalafon\InstanciaGestionEducativaDescentralizada;
use Illuminate\Http\Request;
use Illuminate\Validation\ValidationException;
use Illuminate\Support\Facades\DB;

class InstanciaGestionEducativaDescentralizadaController extends Controller
{

    public function index(Request $request)
    {
        try {    
            $query = InstanciaGestionEducativaDescentralizada::query();
    ...
    public function listarPaginado(Request $request)
    {
        try {    
            ...
            $result = InstanciaGestionEducativaDescentralizada::fromStoredProcedure(
                $filters,
                $page,
                $pageSize,
                $sortColumn,
    ...
    public function store(Request $request)
    {
        try {
            ...
            DB::beginTransaction();
            $resource = InstanciaGestionEducativaDescentralizada::create($validatedData);
            DB::commit();
    ...
    {
        try {
            $resource = InstanciaGestionEducativaDescentralizada::findOrFail($id);
            return response()->json([
                'success' => true,
                'data' => $resource
            ]);
