...
use App\Models\Escalafon\VMantenimientoInstanciaGestionEducativaDescentralizada;
use Illuminate\Http\Request;
use Illuminate\Validation\ValidationException;
use Illuminate\Support\Facades\DB;

class VMantenimientoInstanciaGestionEducativaDescentralizadaController extends Controller
{

    public function index(Request $request)
    {
        try {    
            $query = VMantenimientoInstanciaGestionEducativaDescentralizada::query();
    ...
    public function listarPaginado(Request $request)
    {
        try {    
            ...
            $result = VMantenimientoInstanciaGestionEducativaDescentralizada::fromStoredProcedure(
                $filters,
                $page,
                $pageSize,
                $sortColumn,
    ...
    public function store(Request $request)
    {
        try {
            ...
            DB::beginTransaction();
            $resource = VMantenimientoInstanciaGestionEducativaDescentralizada::create($validatedData);
            DB::commit();
    ...
    {
        try {
            $resource = VMantenimientoInstanciaGestionEducativaDescentralizada::findOrFail($id);
            return response()->json([
                'success' => true,
                'data' => $resource
            ]);
