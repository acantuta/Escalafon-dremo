...
use App\Models\Escalafon\ExperienciaLaboralSector;
use Illuminate\Http\Request;
use Illuminate\Validation\ValidationException;
use Illuminate\Support\Facades\DB;

class ExperienciaLaboralSectorController extends Controller
{

    public function index(Request $request)
    {
        try {    
            $query = ExperienciaLaboralSector::query();
    ...
    public function listarPaginado(Request $request)
    {
        try {    
            ...
            $result = ExperienciaLaboralSector::fromStoredProcedure(
                $filters,
                $page,
                $pageSize,
                $sortColumn,
    ...
    public function store(Request $request)
    {
        try {
            ...
            DB::beginTransaction();
            $resource = ExperienciaLaboralSector::create($validatedData);
            DB::commit();
    ...
    {
        try {
            $resource = ExperienciaLaboralSector::findOrFail($id);
            return response()->json([
                'success' => true,
                'data' => $resource
            ]);
