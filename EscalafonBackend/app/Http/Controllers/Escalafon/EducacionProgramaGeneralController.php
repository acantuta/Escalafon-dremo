...
use App\Models\Escalafon\EducacionProgramaGeneral;
use Illuminate\Http\Request;
use Illuminate\Validation\ValidationException;
use Illuminate\Support\Facades\DB;

class EducacionProgramaGeneralController extends Controller
{

    public function index(Request $request)
    {
        try {    
            $query = EducacionProgramaGeneral::query();
    ...
    public function listarPaginado(Request $request)
    {
        try {    
            ...
            $result = EducacionProgramaGeneral::fromStoredProcedure(
                $filters,
                $page,
                $pageSize,
                $sortColumn,
    ...
    public function store(Request $request)
    {
        try {
            ...
            DB::beginTransaction();
            $resource = EducacionProgramaGeneral::create($validatedData);
            DB::commit();
    ...
    {
        try {
            $resource = EducacionProgramaGeneral::findOrFail($id);
            return response()->json([
                'success' => true,
                'data' => $resource
            ]);
