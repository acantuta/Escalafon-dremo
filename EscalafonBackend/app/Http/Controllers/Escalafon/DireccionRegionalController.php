...
use App\Models\Escalafon\DireccionRegional;
...
class DireccionRegionalController extends Controller
{
    ...
    public function listarPaginado(Request $request)
    {
        try {    
            ...
            $result = DireccionRegional::fromStoredProcedure(
                $filters,
                $page,
                $pageSize,
                $sortColumn,
    ...
    public function store(Request $request)
    {
        try {
            ...
            DB::beginTransaction();
            $resource = DireccionRegional::create($validatedData);
            DB::commit();
    ...
    {
        try {
            $resource = DireccionRegional::findOrFail($id);
            return response()->json([
                'success' => true,
                'data' => $resource
            ]);
