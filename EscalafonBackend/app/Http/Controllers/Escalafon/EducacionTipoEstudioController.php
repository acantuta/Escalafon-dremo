...
use App\Models\Escalafon\EducacionTipoEstudio;
use Illuminate\Http\Request;
use Illuminate\Validation\ValidationException;
use Illuminate\Support\Facades\DB;

class EducacionTipoEstudioController extends Controller
{

    public function index(Request $request)
    {
        try {    
            $query = EducacionTipoEstudio::query();
    ...
    public function listarPaginado(Request $request)
    {
        try {    
            ...
            $result = EducacionTipoEstudio::fromStoredProcedure(
                $filters,
                $page,
                $pageSize,
                $sortColumn,
    ...
    public function store(Request $request)
    {
        try {
            ...
            DB::beginTransaction();
            $resource = EducacionTipoEstudio::create($validatedData);
            DB::commit();
    ...
    {
        try {
            $resource = EducacionTipoEstudio::findOrFail($id);
            return response()->json([
                'success' => true,
                'data' => $resource
            ]);
