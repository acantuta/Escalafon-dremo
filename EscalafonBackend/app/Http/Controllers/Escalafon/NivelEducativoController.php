...
use App\Models\Escalafon\NivelEducativo;
...
class NivelEducativoController extends Controller
{
    ...
    public function listarPaginado(Request $request)
    {
        try {    
            ...
            $result = NivelEducativo::fromStoredProcedure(
                $filters,
                $page,
                $pageSize,
                $sortColumn,
    ...
    public function store(Request $request)
    {
        try {
            ...
            DB::beginTransaction();
            $resource = NivelEducativo::create($validatedData);
            DB::commit();
    ...
    {
        try {
            $resource = NivelEducativo::findOrFail($id);
            return response()->json([
                'success' => true,
                'data' => $resource
            ]);
