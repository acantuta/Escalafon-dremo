...
use App\Models\Escalafon\AscensoMotivo;
use Illuminate\Http\Request;
use Illuminate\Validation\ValidationException;
use Illuminate\Support\Facades\DB;

class AscensoMotivoController extends Controller
{

    public function index(Request $request)
    {
        try {    
            $query = AscensoMotivo::query();
    ...
    public function listarPaginado(Request $request)
    {
        try {    
            ...
            $result = AscensoMotivo::fromStoredProcedure(
                $filters,
                $page,
                $pageSize,
                $sortColumn,
    ...
    public function store(Request $request)
    {
        try {
            ...
            DB::beginTransaction();
            $resource = AscensoMotivo::create($validatedData);
            DB::commit();
    ...
    {
        try {
            $resource = AscensoMotivo::findOrFail($id);
            return response()->json([
                'success' => true,
                'data' => $resource
            ]);
