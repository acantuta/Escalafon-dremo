...
use App\Models\Escalafon\EducacionProgramaProfesional;
use Illuminate\Http\Request;
use Illuminate\Validation\ValidationException;
use Illuminate\Support\Facades\DB;

class EducacionProgramaProfesionalController extends Controller
{

    public function index(Request $request)
    {
        try {    
            $query = EducacionProgramaProfesional::query();
    ...
    public function listarPaginado(Request $request)
    {
        try {    
            ...
            $result = EducacionProgramaProfesional::fromStoredProcedure(
                $filters,
                $page,
                $pageSize,
                $sortColumn,
    ...
    public function store(Request $request)
    {
        try {
            ...
            DB::beginTransaction();
            $resource = EducacionProgramaProfesional::create($validatedData);
            DB::commit();
    ...
    {
        try {
            $resource = EducacionProgramaProfesional::findOrFail($id);
            return response()->json([
                'success' => true,
                'data' => $resource
            ]);
