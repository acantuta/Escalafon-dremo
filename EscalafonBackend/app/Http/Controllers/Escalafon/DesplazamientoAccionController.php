...
use App\Models\Escalafon\DesplazamientoAccion;
use Illuminate\Http\Request;
use Illuminate\Validation\ValidationException;
use Illuminate\Support\Facades\DB;

class DesplazamientoAccionController extends Controller
{

    public function index(Request $request)
    {
        try {    
            $query = DesplazamientoAccion::query();
    ...
    public function listarPaginado(Request $request)
    {
        try {    
            ...
            $result = DesplazamientoAccion::fromStoredProcedure(
                $filters,
                $page,
                $pageSize,
                $sortColumn,
    ...
    public function store(Request $request)
    {
        try {
            ...
            DB::beginTransaction();
            $resource = DesplazamientoAccion::create($validatedData);
            DB::commit();
    ...
    {
        try {
            $resource = DesplazamientoAccion::findOrFail($id);
            return response()->json([
                'success' => true,
                'data' => $resource
            ]);
