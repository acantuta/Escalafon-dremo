...
class PaisController extends Controller
{
    ...
    public function listarPaginado(Request $request)
    {
        try {    
            ...
            $result = Pais::fromStoredProcedure(
                $filters,
                $page,
                $pageSize,
                $sortColumn,
    ...
    public function store(Request $request)
    {
        try {
            $validatedData = $request->validate([
                'cPaisCodigo' => 'nullable|string|max:10',
            'cPaisNombre' => 'nullable|string|max:100',
            'cPaisAbreviatura1' => 'nullable|string|max:10',
            'cPaisAbreviatura2' => 'nullable|string|max:10',
            'cPaisCodigoSunat' => 'nullable|string|max:10',
            'cPaisGentilicio' => 'nullable|string|max:100',

            ]);

            DB::beginTransaction();
            $resource = Pais::create($validatedData);
            DB::commit();
