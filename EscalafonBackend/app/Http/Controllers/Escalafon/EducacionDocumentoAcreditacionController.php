...
use App\Models\Escalafon\EducacionDocumentoAcreditacion;
use Illuminate\Http\Request;
use Illuminate\Validation\ValidationException;
use Illuminate\Support\Facades\DB;

class EducacionDocumentoAcreditacionController extends Controller
{

    public function index(Request $request)
    {
        try {    
            $query = EducacionDocumentoAcreditacion::query();
    ...
    public function listarPaginado(Request $request)
    {
        try {    
            ...
            $result = EducacionDocumentoAcreditacion::fromStoredProcedure(
                $filters,
                $page,
                $pageSize,
                $sortColumn,
    ...
    public function store(Request $request)
    {
        try {
            ...
            DB::beginTransaction();
            $resource = EducacionDocumentoAcreditacion::create($validatedData);
            DB::commit();
    ...
    {
        try {
            $resource = EducacionDocumentoAcreditacion::findOrFail($id);
            return response()->json([
                'success' => true,
                'data' => $resource
            ]);
