...
use App\Models\Escalafon\EducacionNivelEducativo;
use Illuminate\Http\Request;
use Illuminate\Validation\ValidationException;
use Illuminate\Support\Facades\DB;

class EducacionNivelEducativoController extends Controller
{

    public function index(Request $request)
    {
        try {    
            $query = EducacionNivelEducativo::query();
    ...
    public function listarPaginado(Request $request)
    {
        try {    
            ...
            $result = EducacionNivelEducativo::fromStoredProcedure(
                $filters,
                $page,
                $pageSize,
                $sortColumn,
    ...
    public function store(Request $request)
    {
        try {
            ...
            DB::beginTransaction();
            $resource = EducacionNivelEducativo::create($validatedData);
            DB::commit();
    ...
    {
        try {
            $resource = EducacionNivelEducativo::findOrFail($id);
            return response()->json([
                'success' => true,
                'data' => $resource
            ]);
