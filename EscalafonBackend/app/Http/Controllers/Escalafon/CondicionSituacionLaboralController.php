...
use App\Models\Escalafon\CondicionSituacionLaboral;
use Illuminate\Http\Request;
use Illuminate\Validation\ValidationException;
use Illuminate\Support\Facades\DB;

class CondicionSituacionLaboralController extends Controller
{

    public function index(Request $request)
    {
        try {    
            $query = CondicionSituacionLaboral::query();
    ...
    public function listarPaginado(Request $request)
    {
        try {    
            ...
            $result = CondicionSituacionLaboral::fromStoredProcedure(
                $filters,
                $page,
                $pageSize,
                $sortColumn,
    ...
    public function store(Request $request)
    {
        try {
            ...
            DB::beginTransaction();
            $resource = CondicionSituacionLaboral::create($validatedData);
            DB::commit();
    ...
    {
        try {
            $resource = CondicionSituacionLaboral::findOrFail($id);
            return response()->json([
                'success' => true,
                'data' => $resource
            ]);
