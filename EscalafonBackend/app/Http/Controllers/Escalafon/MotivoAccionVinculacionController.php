...
use App\Models\Escalafon\MotivoAccionVinculacion;
use Illuminate\Http\Request;
use Illuminate\Validation\ValidationException;
use Illuminate\Support\Facades\DB;

class MotivoAccionVinculacionController extends Controller
{

    public function index(Request $request)
    {
        try {    
            $query = MotivoAccionVinculacion::query();
    ...
    public function listarPaginado(Request $request)
    {
        try {    
            ...
            $result = MotivoAccionVinculacion::fromStoredProcedure(
                $filters,
                $page,
                $pageSize,
                $sortColumn,
    ...
    public function store(Request $request)
    {
        try {
            ...
            DB::beginTransaction();
            $resource = MotivoAccionVinculacion::create($validatedData);
            DB::commit();
    ...
    {
        try {
            $resource = MotivoAccionVinculacion::findOrFail($id);
            return response()->json([
                'success' => true,
                'data' => $resource
            ]);
