...
use App\Models\Escalafon\VMovimientoAccionMotivoRegimen;
use Illuminate\Http\Request;
use Illuminate\Validation\ValidationException;
use Illuminate\Support\Facades\DB;

class VMovimientoAccionMotivoRegimenController extends Controller
{

    public function index(Request $request)
    {
        try {    
            $query = VMovimientoAccionMotivoRegimen::query();
    ...
    public function listarPaginado(Request $request)
    {
        try {    
            ...
            $result = VMovimientoAccionMotivoRegimen::fromStoredProcedure(
                $filters,
                $page,
                $pageSize,
                $sortColumn,
    ...
    public function store(Request $request)
    {
        try {
            ...
            DB::beginTransaction();
            $resource = VMovimientoAccionMotivoRegimen::create($validatedData);
            DB::commit();
    ...
    {
        try {
            $resource = VMovimientoAccionMotivoRegimen::findOrFail($id);
            return response()->json([
                'success' => true,
                'data' => $resource
            ]);
