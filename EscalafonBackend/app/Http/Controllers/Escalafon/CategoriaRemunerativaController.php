...
use App\Models\Escalafon\CategoriaRemunerativa;
use Illuminate\Http\Request;
use Illuminate\Validation\ValidationException;
use Illuminate\Support\Facades\DB;

class CategoriaRemunerativaController extends Controller
{

    public function index(Request $request)
    {
        try {    
            $query = CategoriaRemunerativa::query();
    ...
    public function listarPaginado(Request $request)
    {
        try {    
            ...
            $result = CategoriaRemunerativa::fromStoredProcedure(
                $filters,
                $page,
                $pageSize,
                $sortColumn,
    ...
    public function store(Request $request)
    {
        try {
            ...
            DB::beginTransaction();
            $resource = CategoriaRemunerativa::create($validatedData);
            DB::commit();
    ...
    {
        try {
            $resource = CategoriaRemunerativa::findOrFail($id);
            return response()->json([
                'success' => true,
                'data' => $resource
            ]);
