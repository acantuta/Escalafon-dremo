...
use App\Models\Escalafon\CeseMotivoAccion;
use Illuminate\Http\Request;
use Illuminate\Validation\ValidationException;
use Illuminate\Support\Facades\DB;

class CeseMotivoAccionController extends Controller
{

    public function index(Request $request)
    {
        try {    
            $query = CeseMotivoAccion::query();
    ...
    public function listarPaginado(Request $request)
    {
        try {    
            ...
            $result = CeseMotivoAccion::fromStoredProcedure(
                $filters,
                $page,
                $pageSize,
                $sortColumn,
    ...
    public function store(Request $request)
    {
        try {
            ...
            DB::beginTransaction();
            $resource = CeseMotivoAccion::create($validatedData);
            DB::commit();
    ...
    {
        try {
            $resource = CeseMotivoAccion::findOrFail($id);
            return response()->json([
                'success' => true,
                'data' => $resource
            ]);
