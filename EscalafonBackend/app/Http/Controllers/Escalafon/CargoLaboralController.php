...
use App\Models\Escalafon\CargoLaboral;
...
class CargoLaboralController extends Controller
{
    ...
    public function listarPaginado(Request $request)
    {
        try {    
            ...
            $result = CargoLaboral::fromStoredProcedure(
                $filters,
                $page,
                $pageSize,
                $sortColumn,
    ...
    public function store(Request $request)
    {
        try {
            ...
            DB::beginTransaction();
            $resource = CargoLaboral::create($validatedData);
            DB::commit();
    ...
    {
        try {
            $resource = CargoLaboral::findOrFail($id);
            return response()->json([
                'success' => true,
                'data' => $resource
            ]);
