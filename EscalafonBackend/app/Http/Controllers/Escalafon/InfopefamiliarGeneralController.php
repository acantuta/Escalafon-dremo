...
use App\Models\Escalafon\InfopefamiliarGeneral;
use Illuminate\Http\Request;
use Illuminate\Validation\ValidationException;
use Illuminate\Support\Facades\DB;

class InfopefamiliarGeneralController extends Controller
{

    public function index(Request $request)
    {
        try {    
            $query = InfopefamiliarGeneral::query();
    ...
    public function listarPaginado(Request $request)
    {
        try {    
            ...
            $result = InfopefamiliarGeneral::fromStoredProcedure(
                $filters,
                $page,
                $pageSize,
                $sortColumn,
    ...
    public function store(Request $request)
    {
        try {
            $validatedData = $request->validate([
                'iInfoPeFamGenId' => 'nullable|integer',

            ]);

            DB::beginTransaction();
            $resource = InfopefamiliarGeneral::create($validatedData);
            DB::commit();
    ...
    {
        try {
            $resource = InfopefamiliarGeneral::findOrFail($id);
            return response()->json([
                'success' => true,
                'data' => $resource
            ]);
