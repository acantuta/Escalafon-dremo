...
use App\Models\Escalafon\VMantenimientoNivelEducativo;
use Illuminate\Http\Request;
use Illuminate\Validation\ValidationException;
use Illuminate\Support\Facades\DB;

class VMantenimientoNivelEducativoController extends Controller
{

    public function index(Request $request)
    {
        try {    
            $query = VMantenimientoNivelEducativo::query();
    ...
    public function listarPaginado(Request $request)
    {
        try {    
            ...
            $result = VMantenimientoNivelEducativo::fromStoredProcedure(
                $filters,
                $page,
                $pageSize,
                $sortColumn,
    ...
    public function store(Request $request)
    {
        try {
            ...
            DB::beginTransaction();
            $resource = VMantenimientoNivelEducativo::create($validatedData);
            DB::commit();
    ...
    {
        try {
            $resource = VMantenimientoNivelEducativo::findOrFail($id);
            return response()->json([
                'success' => true,
                'data' => $resource
            ]);
