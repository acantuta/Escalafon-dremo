...
use App\Models\Escalafon\EducacionCarrera;
use Illuminate\Http\Request;
use Illuminate\Validation\ValidationException;
use Illuminate\Support\Facades\DB;

class EducacionCarreraController extends Controller
{

    public function index(Request $request)
    {
        try {    
            $query = EducacionCarrera::query();
    ...
    public function listarPaginado(Request $request)
    {
        try {    
            ...
            $result = EducacionCarrera::fromStoredProcedure(
                $filters,
                $page,
                $pageSize,
                $sortColumn,
    ...
    public function store(Request $request)
    {
        try {
            ...
            DB::beginTransaction();
            $resource = EducacionCarrera::create($validatedData);
            DB::commit();
    ...
    {
        try {
            $resource = EducacionCarrera::findOrFail($id);
            return response()->json([
                'success' => true,
                'data' => $resource
            ]);
