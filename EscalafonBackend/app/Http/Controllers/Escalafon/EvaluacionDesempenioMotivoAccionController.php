...
use App\Models\Escalafon\EvaluacionDesempenioMotivoAccion;
use Illuminate\Http\Request;
use Illuminate\Validation\ValidationException;
use Illuminate\Support\Facades\DB;

class EvaluacionDesempenioMotivoAccionController extends Controller
{

    public function index(Request $request)
    {
        try {    
            $query = EvaluacionDesempenioMotivoAccion::query();
    ...
    public function listarPaginado(Request $request)
    {
        try {    
            ...
            $result = EvaluacionDesempenioMotivoAccion::fromStoredProcedure(
                $filters,
                $page,
                $pageSize,
                $sortColumn,
    ...
    public function store(Request $request)
    {
        try {
            ...
            DB::beginTransaction();
            $resource = EvaluacionDesempenioMotivoAccion::create($validatedData);
            DB::commit();
    ...
    {
        try {
            $resource = EvaluacionDesempenioMotivoAccion::findOrFail($id);
            return response()->json([
                'success' => true,
                'data' => $resource
            ]);
