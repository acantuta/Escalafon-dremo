...
use App\Models\Escalafon\CompensacionAccion;
use Illuminate\Http\Request;
use Illuminate\Validation\ValidationException;
use Illuminate\Support\Facades\DB;

class CompensacionAccionController extends Controller
{

    public function index(Request $request)
    {
        try {    
            $query = CompensacionAccion::query();
    ...
    public function listarPaginado(Request $request)
    {
        try {    
            ...
            $result = CompensacionAccion::fromStoredProcedure(
                $filters,
                $page,
                $pageSize,
                $sortColumn,
    ...
    public function store(Request $request)
    {
        try {
            ...
            DB::beginTransaction();
            $resource = CompensacionAccion::create($validatedData);
            DB::commit();
    ...
    {
        try {
            $resource = CompensacionAccion::findOrFail($id);
            return response()->json([
                'success' => true,
                'data' => $resource
            ]);
