...
use App\Models\Escalafon\MovimientoAccionMotivoRegimen;
use Illuminate\Http\Request;
use Illuminate\Validation\ValidationException;
use Illuminate\Support\Facades\DB;

class MovimientoAccionMotivoRegimenController extends Controller
{

    public function index(Request $request)
    {
        try {    
            $query = MovimientoAccionMotivoRegimen::query();
    ...
    public function listarPaginado(Request $request)
    {
        try {    
            ...
            $result = MovimientoAccionMotivoRegimen::fromStoredProcedure(
                $filters,
                $page,
                $pageSize,
                $sortColumn,
    ...
    public function store(Request $request)
    {
        try {
            ...
            DB::beginTransaction();
            $resource = MovimientoAccionMotivoRegimen::create($validatedData);
            DB::commit();
    ...
    {
        try {
            $resource = MovimientoAccionMotivoRegimen::findOrFail($id);
            return response()->json([
                'success' => true,
                'data' => $resource
            ]);
