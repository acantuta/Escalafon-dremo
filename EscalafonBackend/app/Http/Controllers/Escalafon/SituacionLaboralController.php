...
use App\Models\Escalafon\SituacionLaboral;
...
class SituacionLaboralController extends Controller
{
    ...
    public function listarPaginado(Request $request)
    {
        try {    
            ...
            $result = SituacionLaboral::fromStoredProcedure(
                $filters,
                $page,
                $pageSize,
                $sortColumn,
    ...
    public function store(Request $request)
    {
        try {
            ...
            DB::beginTransaction();
            $resource = SituacionLaboral::create($validatedData);
            DB::commit();
    ...
    {
        try {
            $resource = SituacionLaboral::findOrFail($id);
            return response()->json([
                'success' => true,
                'data' => $resource
            ]);
