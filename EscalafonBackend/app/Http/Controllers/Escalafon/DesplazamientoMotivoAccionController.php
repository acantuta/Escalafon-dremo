...
use App\Models\Escalafon\DesplazamientoMotivoAccion;
use Illuminate\Http\Request;
use Illuminate\Validation\ValidationException;
use Illuminate\Support\Facades\DB;

class DesplazamientoMotivoAccionController extends Controller
{

    public function index(Request $request)
    {
        try {    
            $query = DesplazamientoMotivoAccion::query();
    ...
    public function listarPaginado(Request $request)
    {
        try {    
            ...
            $result = DesplazamientoMotivoAccion::fromStoredProcedure(
                $filters,
                $page,
                $pageSize,
                $sortColumn,
    ...
    public function store(Request $request)
    {
        try {
            ...
            DB::beginTransaction();
            $resource = DesplazamientoMotivoAccion::create($validatedData);
            DB::commit();
    ...
    {
        try {
            $resource = DesplazamientoMotivoAccion::findOrFail($id);
            return response()->json([
                'success' => true,
                'data' => $resource
            ]);
