...
use App\Models\Escalafon\EvaluacionDesempenio;
...
class EvaluacionDesempenioController extends Controller
{
    ...
    {
        try {    
            $query = EvaluacionDesempenio::query();
    ...
    public function listarPaginado(Request $request)
    {
        try {    
            ...
            $result = EvaluacionDesempenio::fromStoredProcedure(
                $filters,
                $page,
                $pageSize,
                $sortColumn,
    ...
    public function store(Request $request)
    {
        try {
            ...
            DB::beginTransaction();
            $resource = EvaluacionDesempenio::create($validatedData);
            DB::commit();
    ...
    {
        try {
            $resource = EvaluacionDesempenio::findOrFail($id);
            return response()->json([
                'success' => true,
                'data' => $resource
            ]);
