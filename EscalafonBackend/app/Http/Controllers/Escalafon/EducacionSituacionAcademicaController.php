...
use App\Models\Escalafon\EducacionSituacionAcademica;
use Illuminate\Http\Request;
use Illuminate\Validation\ValidationException;
use Illuminate\Support\Facades\DB;

class EducacionSituacionAcademicaController extends Controller
{

    public function index(Request $request)
    {
        try {    
            $query = EducacionSituacionAcademica::query();
    ...
    public function listarPaginado(Request $request)
    {
        try {    
            ...
            $result = EducacionSituacionAcademica::fromStoredProcedure(
                $filters,
                $page,
                $pageSize,
                $sortColumn,
    ...
    public function store(Request $request)
    {
        try {
            ...
            DB::beginTransaction();
            $resource = EducacionSituacionAcademica::create($validatedData);
            DB::commit();
    ...
    {
        try {
            $resource = EducacionSituacionAcademica::findOrFail($id);
            return response()->json([
                'success' => true,
                'data' => $resource
            ]);
