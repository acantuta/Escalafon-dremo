...
class VOtroController extends Controller
{
    ...
    public function listarPaginado(Request $request)
    {
        try {    
            ...
            $result = VOtro::fromStoredProcedure(
                $filters,
                $page,
                $pageSize,
                $sortColumn,
    ...
    public function store(Request $request)
    {
        try {
            ...
            'dtOtrosFechaEmision' => 'required|date',
            'cOtrosAnotaciones' => 'nullable|string',
            'iOtrosId' => 'required|integer',
            ...
            DB::beginTransaction();
            $resource = VOtro::create($validatedData);
            DB::commit();
