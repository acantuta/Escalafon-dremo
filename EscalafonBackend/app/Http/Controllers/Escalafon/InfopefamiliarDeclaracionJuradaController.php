...
use App\Models\Escalafon\InfopefamiliarDeclaracionJurada;
use Illuminate\Http\Request;
use Illuminate\Validation\ValidationException;
use Illuminate\Support\Facades\DB;

class InfopefamiliarDeclaracionJuradaController extends Controller
{

    public function index(Request $request)
    {
        try {    
            $query = InfopefamiliarDeclaracionJurada::query();
    ...
    public function listarPaginado(Request $request)
    {
        try {    
            ...
            $result = InfopefamiliarDeclaracionJurada::fromStoredProcedure(
                $filters,
                $page,
                $pageSize,
                $sortColumn,
    ...
    public function store(Request $request)
    {
        try {
            ...
            DB::beginTransaction();
            $resource = InfopefamiliarDeclaracionJurada::create($validatedData);
            DB::commit();
    ...
    {
        try {
            $resource = InfopefamiliarDeclaracionJurada::findOrFail($id);
            return response()->json([
                'success' => true,
                'data' => $resource
            ]);
