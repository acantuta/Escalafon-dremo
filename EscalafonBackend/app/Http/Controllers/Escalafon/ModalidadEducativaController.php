...
use App\Models\Escalafon\ModalidadEducativa;
use Illuminate\Http\Request;
use Illuminate\Validation\ValidationException;
use Illuminate\Support\Facades\DB;

class ModalidadEducativaController extends Controller
{

    public function index(Request $request)
    {
        try {    
            $query = ModalidadEducativa::query();
    ...
    public function listarPaginado(Request $request)
    {
        try {    
            ...
            $result = ModalidadEducativa::fromStoredProcedure(
                $filters,
                $page,
                $pageSize,
                $sortColumn,
    ...
    public function store(Request $request)
    {
        try {
            ...
            DB::beginTransaction();
            $resource = ModalidadEducativa::create($validatedData);
            DB::commit();
    ...
    {
        try {
            $resource = ModalidadEducativa::findOrFail($id);
            return response()->json([
                'success' => true,
                'data' => $resource
            ]);
