...
use App\Models\Escalafon\CentroLaboral;
...
class CentroLaboralController extends Controller
{
    ...
    public function listarPaginado(Request $request)
    {
        try {    
            ...
            $result = CentroLaboral::fromStoredProcedure(
                $filters,
                $page,
                $pageSize,
                $sortColumn,
    ...
    public function store(Request $request)
    {
        try {
            ...
            DB::beginTransaction();
            $resource = CentroLaboral::create($validatedData);
            DB::commit();
    ...
    {
        try {
            $resource = CentroLaboral::findOrFail($id);
            return response()->json([
                'success' => true,
                'data' => $resource
            ]);
