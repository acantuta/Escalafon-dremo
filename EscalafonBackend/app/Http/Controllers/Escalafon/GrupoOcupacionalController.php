...
use App\Models\Escalafon\GrupoOcupacional;
...
class GrupoOcupacionalController extends Controller
{
    ...
    public function listarPaginado(Request $request)
    {
        try {    
            ...
            $result = GrupoOcupacional::fromStoredProcedure(
                $filters,
                $page,
                $pageSize,
                $sortColumn,
    ...
    public function store(Request $request)
    {
        try {
            ...
            DB::beginTransaction();
            $resource = GrupoOcupacional::create($validatedData);
            DB::commit();
    ...
    {
        try {
            $resource = GrupoOcupacional::findOrFail($id);
            return response()->json([
                'success' => true,
                'data' => $resource
            ]);
