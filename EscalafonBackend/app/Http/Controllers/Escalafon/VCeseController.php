...
class VCeseController extends Controller
{
    ...
    public function listarPaginado(Request $request)
    {
        try {    
            ...
            $result = VCese::fromStoredProcedure(
                $filters,
                $page,
                $pageSize,
                $sortColumn,
    ...
    public function store(Request $request)
    {
        try {
            ...
            'iCesAccId' => 'nullable|integer',
            'iCesMotAccId' => 'nullable|integer',
            'cCesesNumeroDocumento' => 'nullable|string|max:150',
            'dtCesesFechaDocumento' => 'nullable|date',
            'iArchId' => 'nullable|integer',
            'iRegLabId' => 'nullable|integer',
            'dtCesesFechaCese' => 'nullable|date',
            'iCesesServicioAnios' => 'nullable|integer',
            'iCesesServicioDias' => 'nullable|integer',
            'iCesesServicioMeses' => 'nullable|integer',
            'cCesesAnotaciones' => 'nullable|string',
            'cCesAccNombre' => 'nullable|string|max:150',
            'cCesMotAccNombre' => 'nullable|string|max:150',
            'iCesesId' => 'nullable|integer',
            ...
            DB::beginTransaction();
            $resource = VCese::create($validatedData);
            DB::commit();
