...
class PersonaController extends Controller
{
    ...
    public function listarPaginado(Request $request)
    {
        try {    
            ...
            $result = Persona::fromStoredProcedure(
                $filters,
                $page,
                $pageSize,
                $sortColumn,
    ...
    public function store(Request $request)
    {
        try {
            ...
            'iTipoSectorId' => 'nullable|integer',
            'iPaisId' => 'nullable|integer',
            'iDptoId' => 'nullable|integer',
            'iPrvnId' => 'nullable|integer',
            'iDsttId' => 'nullable|integer',
            'iPersEstado' => 'nullable|integer',
            'cPersCodigoVerificacion' => 'nullable|string',
            'cPersObs' => 'nullable|string',
            'iCredSesionId' => 'nullable|integer',
            'dtPersCreado' => 'nullable|date',
            'dtPersActualizado' => 'nullable|date',

            ]);

            DB::beginTransaction();
            $resource = Persona::create($validatedData);
            DB::commit();
    ...
    {
        try {
            $resource = Persona::findOrFail($id);
            return response()->json([
                'success' => true,
                'data' => $resource
            ]);
