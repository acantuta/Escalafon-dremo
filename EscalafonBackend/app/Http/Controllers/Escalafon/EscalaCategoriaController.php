...
use App\Models\Escalafon\EscalaCategoria;
use Illuminate\Http\Request;
use Illuminate\Validation\ValidationException;
use Illuminate\Support\Facades\DB;

class EscalaCategoriaController extends Controller
{

    public function index(Request $request)
    {
        try {    
            $query = EscalaCategoria::query();
    ...
    public function listarPaginado(Request $request)
    {
        try {    
            ...
            $result = EscalaCategoria::fromStoredProcedure(
                $filters,
                $page,
                $pageSize,
                $sortColumn,
    ...
    public function store(Request $request)
    {
        try {
            ...
            DB::beginTransaction();
            $resource = EscalaCategoria::create($validatedData);
            DB::commit();
    ...
    {
        try {
            $resource = EscalaCategoria::findOrFail($id);
            return response()->json([
                'success' => true,
                'data' => $resource
            ]);
