...
use App\Models\Escalafon\ExperienciaLaboral;
...
class ExperienciaLaboralController extends Controller
{
    ...
    {
        try {    
            $query = ExperienciaLaboral::query();
    ...
    public function listarPaginado(Request $request)
    {
        try {    
            ...
            $result = ExperienciaLaboral::fromStoredProcedure(
                $filters,
                $page,
                $pageSize,
                $sortColumn,
    ...
    public function store(Request $request)
    {
        try {
            ...
            DB::beginTransaction();
            $resource = ExperienciaLaboral::create($validatedData);
            DB::commit();
    ...
    {
        try {
            $resource = ExperienciaLaboral::findOrFail($id);
            return response()->json([
                'success' => true,
                'data' => $resource
            ]);
