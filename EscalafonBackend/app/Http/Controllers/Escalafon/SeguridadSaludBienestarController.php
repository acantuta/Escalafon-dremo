...
use App\Models\Escalafon\SeguridadSaludBienestar;
use Illuminate\Http\Request;
use Illuminate\Validation\ValidationException;
use Illuminate\Support\Facades\DB;

class SeguridadSaludBienestarController extends Controller
{

    public function index(Request $request)
    {
        try {    
            $query = SeguridadSaludBienestar::query();
    ...
    public function listarPaginado(Request $request)
    {
        try {    
            ...
            $result = SeguridadSaludBienestar::fromStoredProcedure(
                $filters,
                $page,
                $pageSize,
                $sortColumn,
    ...
    public function store(Request $request)
    {
        try {
            ...
            DB::beginTransaction();
            $resource = SeguridadSaludBienestar::create($validatedData);
            DB::commit();
    ...
    {
        try {
            $resource = SeguridadSaludBienestar::findOrFail($id);
            return response()->json([
                'success' => true,
                'data' => $resource
            ]);
