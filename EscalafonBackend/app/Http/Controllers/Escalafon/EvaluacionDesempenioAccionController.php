...
use App\Models\Escalafon\EvaluacionDesempenioAccion;
use Illuminate\Http\Request;
use Illuminate\Validation\ValidationException;
use Illuminate\Support\Facades\DB;

class EvaluacionDesempenioAccionController extends Controller
{

    public function index(Request $request)
    {
        try {    
            $query = EvaluacionDesempenioAccion::query();
    ...
    public function listarPaginado(Request $request)
    {
        try {    
            ...
            $result = EvaluacionDesempenioAccion::fromStoredProcedure(
                $filters,
                $page,
                $pageSize,
                $sortColumn,
    ...
    public function store(Request $request)
    {
        try {
            ...
            DB::beginTransaction();
            $resource = EvaluacionDesempenioAccion::create($validatedData);
            DB::commit();
    ...
    {
        try {
            $resource = EvaluacionDesempenioAccion::findOrFail($id);
            return response()->json([
                'success' => true,
                'data' => $resource
            ]);
