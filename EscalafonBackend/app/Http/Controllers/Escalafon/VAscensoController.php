...
class VAscensoController extends Controller
{

    public function index(Request $request)
    {
        try {    
            $query = VAscenso::query();
    ...
    public function listarPaginado(Request $request)
    {
        try {    
            ...
            $result = VAscenso::fromStoredProcedure(
                $filters,
                $page,
                $pageSize,
                $sortColumn,
    ...
    public function store(Request $request)
    {
        try {
            ...
            'cAscNumeroDocumento' => 'nullable|string|max:150',
            'dtAscFechaDocumento' => 'nullable|date',
            'iArchId' => 'nullable|integer',
            'iRegLabId' => 'nullable|integer',
            'iAscAccId' => 'nullable|integer',
            'iAscMotId' => 'nullable|integer',
            'dtAscFechaInicio' => 'nullable|date',
            'iAscEscCatId' => 'nullable|integer',
            'iAscEscCatIdNueva' => 'nullable|integer',
            'cAscAnotaciones' => 'nullable|string',
            'cAscAccNombre' => 'nullable|string|max:150',
            'cAscMotNombre' => 'nullable|string|max:150',
            'cRegLabNombre' => 'nullable|string|max:300',
            'idAscId' => 'nullable|integer',
            'iLegId' => 'nullable|integer',

            ]);

            DB::beginTransaction();
            $resource = VAscenso::create($validatedData);
            DB::commit();
    ...
    {
        try {
            $resource = VAscenso::findOrFail($id);
            return response()->json([
                'success' => true,
                'data' => $resource
            ]);
