...
use App\Models\Escalafon\VMantenimientoMovimientoAccionMotivoRegimen;
use Illuminate\Http\Request;
use Illuminate\Validation\ValidationException;
use Illuminate\Support\Facades\DB;

class VMantenimientoMovimientoAccionMotivoRegimenController extends Controller
{

    public function index(Request $request)
    {
        try {    
            $query = VMantenimientoMovimientoAccionMotivoRegimen::query();
    ...
    public function listarPaginado(Request $request)
    {
        try {    
            ...
            $result = VMantenimientoMovimientoAccionMotivoRegimen::fromStoredProcedure(
                $filters,
                $page,
                $pageSize,
                $sortColumn,
    ...
    public function store(Request $request)
    {
        try {
            $validatedData = $request->validate([
                'iMovAccMotRegId' => 'required|integer',
            ...
            DB::beginTransaction();
            $resource = VMantenimientoMovimientoAccionMotivoRegimen::create($validatedData);
            DB::commit();
    ...
    {
        try {
            $resource = VMantenimientoMovimientoAccionMotivoRegimen::findOrFail($id);
            return response()->json([
                'success' => true,
                'data' => $resource
            ]);
