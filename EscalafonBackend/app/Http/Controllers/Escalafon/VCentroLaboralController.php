...
use App\Models\Escalafon\VCentroLaboral;
use Illuminate\Http\Request;
use Illuminate\Validation\ValidationException;
use Illuminate\Support\Facades\DB;

class VCentroLaboralController extends Controller
{

    public function index(Request $request)
    {
        try {    
            $query = VCentroLaboral::query();
    ...
    public function listarPaginado(Request $request)
    {
        try {    
            ...
            $result = VCentroLaboral::fromStoredProcedure(
                $filters,
                $page,
                $pageSize,
                $sortColumn,
    ...
    public function store(Request $request)
    {
        try {
            ...
            DB::beginTransaction();
            $resource = VCentroLaboral::create($validatedData);
            DB::commit();
    ...
    {
        try {
            $resource = VCentroLaboral::findOrFail($id);
            return response()->json([
                'success' => true,
                'data' => $resource
            ]);
