...
use App\Models\Escalafon\VMantenimientoCompensacionMotivoAccion;
use Illuminate\Http\Request;
use Illuminate\Validation\ValidationException;
use Illuminate\Support\Facades\DB;

class VMantenimientoCompensacionMotivoAccionController extends Controller
{

    public function index(Request $request)
    {
        try {    
            $query = VMantenimientoCompensacionMotivoAccion::query();
    ...
    public function listarPaginado(Request $request)
    {
        try {    
            ...
            $result = VMantenimientoCompensacionMotivoAccion::fromStoredProcedure(
                $filters,
                $page,
                $pageSize,
                $sortColumn,
    ...
    public function store(Request $request)
    {
        try {
            ...
            DB::beginTransaction();
            $resource = VMantenimientoCompensacionMotivoAccion::create($validatedData);
            DB::commit();
    ...
    {
        try {
            $resource = VMantenimientoCompensacionMotivoAccion::findOrFail($id);
            return response()->json([
                'success' => true,
                'data' => $resource
            ]);
