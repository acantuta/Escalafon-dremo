...
use App\Models\Escalafon\CompensacionMotivoAccion;
use Illuminate\Http\Request;
use Illuminate\Validation\ValidationException;
use Illuminate\Support\Facades\DB;

class CompensacionMotivoAccionController extends Controller
{

    public function index(Request $request)
    {
        try {    
            $query = CompensacionMotivoAccion::query();
    ...
    public function listarPaginado(Request $request)
    {
        try {    
            ...
            $result = CompensacionMotivoAccion::fromStoredProcedure(
                $filters,
                $page,
                $pageSize,
                $sortColumn,
    ...
    public function store(Request $request)
    {
        try {
            ...
            DB::beginTransaction();
            $resource = CompensacionMotivoAccion::create($validatedData);
            DB::commit();
    ...
    {
        try {
            $resource = CompensacionMotivoAccion::findOrFail($id);
            return response()->json([
                'success' => true,
                'data' => $resource
            ]);
