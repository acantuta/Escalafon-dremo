...
use App\Models\Escalafon\AscensoAccion;
use Illuminate\Http\Request;
use Illuminate\Validation\ValidationException;
use Illuminate\Support\Facades\DB;

class AscensoAccionController extends Controller
{

    public function index(Request $request)
    {
        try {    
            $query = AscensoAccion::query();
    ...
    public function listarPaginado(Request $request)
    {
        try {    
            ...
            $result = AscensoAccion::fromStoredProcedure(
                $filters,
                $page,
                $pageSize,
                $sortColumn,
    ...
    public function store(Request $request)
    {
        try {
            ...
            DB::beginTransaction();
            $resource = AscensoAccion::create($validatedData);
            DB::commit();
    ...
    {
        try {
            $resource = AscensoAccion::findOrFail($id);
            return response()->json([
                'success' => true,
                'data' => $resource
            ]);
