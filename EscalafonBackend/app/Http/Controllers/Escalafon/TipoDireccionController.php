...
use App\Models\Escalafon\TipoDireccion;
...
class TipoDireccionController extends Controller
{
    ...
    public function listarPaginado(Request $request)
    {
        try {    
            ...
            $result = TipoDireccion::fromStoredProcedure(
                $filters,
                $page,
                $pageSize,
                $sortColumn,
    ...
    public function store(Request $request)
    {
        try {
            ...
            DB::beginTransaction();
            $resource = TipoDireccion::create($validatedData);
            DB::commit();
    ...
    {
        try {
            $resource = TipoDireccion::findOrFail($id);
            return response()->json([
                'success' => true,
                'data' => $resource
            ]);
