...
use App\Models\Escalafon\Reconocimiento;
...
class ReconocimientoController extends Controller
{
    ...
    public function listarPaginado(Request $request)
    {
        try {    
            ...
            $result = Reconocimiento::fromStoredProcedure(
                $filters,
                $page,
                $pageSize,
                $sortColumn,
    ...
    public function store(Request $request)
    {
        try {
            ...
            DB::beginTransaction();
            $resource = Reconocimiento::create($validatedData);
            DB::commit();
    ...
    {
        try {
            $resource = Reconocimiento::findOrFail($id);
            return response()->json([
                'success' => true,
                'data' => $resource
            ]);
