...
use App\Models\Escalafon\JornadaLaboral;
...
class JornadaLaboralController extends Controller
{
    ...
    public function listarPaginado(Request $request)
    {
        try {    
            ...
            $result = JornadaLaboral::fromStoredProcedure(
                $filters,
                $page,
                $pageSize,
                $sortColumn,
    ...
    public function store(Request $request)
    {
        try {
            ...
            DB::beginTransaction();
            $resource = JornadaLaboral::create($validatedData);
            DB::commit();
    ...
    {
        try {
            $resource = JornadaLaboral::findOrFail($id);
            return response()->json([
                'success' => true,
                'data' => $resource
            ]);
