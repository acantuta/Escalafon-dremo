...
class CeseController extends Controller
{
    ...
    public function listarPaginado(Request $request)
    {
        try {    
            ...
            $result = Cese::fromStoredProcedure(
                $filters,
                $page,
                $pageSize,
                $sortColumn,
    ...
    public function store(Request $request)
    {
        try {
            ...
            'iCesAccId' => 'required|integer',
            'iCesMotAccId' => 'required|integer',
            'cCesesNumeroDocumento' => 'required|string|max:150',
            'dtCesesFechaDocumento' => 'required|date',
            'iArchId' => 'required|integer',
            'iRegLabId' => 'required|integer',
            'dtCesesFechaCese' => 'required|date',
            ...
            DB::beginTransaction();
            $resource = Cese::create($validatedData);
            DB::commit();
