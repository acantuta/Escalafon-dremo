...
use App\Models\Escalafon\Ascenso;
...
class AscensoController extends Controller
{
    ...
    public function listarPaginado(Request $request)
    {
        try {    
            ...
            $result = Ascenso::fromStoredProcedure(
                $filters,
                $page,
                $pageSize,
                $sortColumn,
    ...
    public function store(Request $request)
    {
        try {
            ...
            'cAscNumeroDocumento' => 'required|string|max:150',
            'dtAscFechaDocumento' => 'required|date',
            ...
            DB::beginTransaction();
            $resource = Ascenso::create($validatedData);
            DB::commit();
    ...
    {
        try {
            $resource = Ascenso::findOrFail($id);
            return response()->json([
                'success' => true,
                'data' => $resource
            ]);
