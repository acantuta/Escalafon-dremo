...
class VSeguridadSaludBienestarController extends Controller
{

    public function index(Request $request)
    {
        try {    
            $query = VSeguridadSaludBienestar::query();
    ...
    public function listarPaginado(Request $request)
    {
        try {    
            ...
            $result = VSeguridadSaludBienestar::fromStoredProcedure(
                $filters,
                $page,
                $pageSize,
                $sortColumn,
    ...
    public function store(Request $request)
    {
        try {
            ...
            'dtSegSalBieFechaEmision' => 'required|date',
            'cSegSalBieAnotaciones' => 'nullable|string',
            'iSegSalBieId' => 'required|integer',
            ...
            DB::beginTransaction();
            $resource = VSeguridadSaludBienestar::create($validatedData);
            DB::commit();
    ...
    {
        try {
            $resource = VSeguridadSaludBienestar::findOrFail($id);
            return response()->json([
                'success' => true,
                'data' => $resource
            ]);
