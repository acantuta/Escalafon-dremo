...
use App\Models\Escalafon\RelacionIndividualColectiva;
use Illuminate\Http\Request;
use Illuminate\Validation\ValidationException;
use Illuminate\Support\Facades\DB;

class RelacionIndividualColectivaController extends Controller
{

    public function index(Request $request)
    {
        try {    
            $query = RelacionIndividualColectiva::query();
    ...
    public function listarPaginado(Request $request)
    {
        try {    
            ...
            $result = RelacionIndividualColectiva::fromStoredProcedure(
                $filters,
                $page,
                $pageSize,
                $sortColumn,
    ...
    public function store(Request $request)
    {
        try {
            ...
            'dtRelaIndColecFechaEmision' => 'required|date',
            'cRelaIndColecAnotaciones' => 'nullable|string',

            ]);

            DB::beginTransaction();
            $resource = RelacionIndividualColectiva::create($validatedData);
            DB::commit();
    ...
    {
        try {
            $resource = RelacionIndividualColectiva::findOrFail($id);
            return response()->json([
                'success' => true,
                'data' => $resource
            ]);
