...
use App\Models\Escalafon\TipoEstadoCivil;
...
class TipoEstadoCivilController extends Controller
{
    ...
    public function listarPaginado(Request $request)
    {
        try {    
            ...
            $result = TipoEstadoCivil::fromStoredProcedure(
                $filters,
                $page,
                $pageSize,
                $sortColumn,
    ...
    public function store(Request $request)
    {
        try {
            ...
            'cTipoEstCivilReniec' => 'nullable|string|max:50',

            ]);

            DB::beginTransaction();
            $resource = TipoEstadoCivil::create($validatedData);
            DB::commit();
    ...
    {
        try {
            $resource = TipoEstadoCivil::findOrFail($id);
            return response()->json([
                'success' => true,
                'data' => $resource
            ]);
