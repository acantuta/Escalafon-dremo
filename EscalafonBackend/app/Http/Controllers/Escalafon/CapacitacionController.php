...
use App\Models\Escalafon\Capacitacion;
...
class CapacitacionController extends Controller
{
    ...
    public function listarPaginado(Request $request)
    {
        try {    
            ...
            $result = Capacitacion::fromStoredProcedure(
                $filters,
                $page,
                $pageSize,
                $sortColumn,
    ...
    public function store(Request $request)
    {
        try {
            ...
            'iEduDocAcredId' => 'nullable|integer',
            ...
            DB::beginTransaction();
            $resource = Capacitacion::create($validatedData);
            DB::commit();
    ...
    {
        try {
            $resource = Capacitacion::findOrFail($id);
            return response()->json([
                'success' => true,
                'data' => $resource
            ]);
