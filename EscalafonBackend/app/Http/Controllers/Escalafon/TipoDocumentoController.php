...
use App\Models\Escalafon\TipoDocumento;
...
class TipoDocumentoController extends Controller
{
    ...
    public function listarPaginado(Request $request)
    {
        try {    
            ...
            $result = TipoDocumento::fromStoredProcedure(
                $filters,
                $page,
                $pageSize,
                $sortColumn,
    ...
    public function store(Request $request)
    {
        try {
            ...
            DB::beginTransaction();
            $resource = TipoDocumento::create($validatedData);
            DB::commit();
    ...
    {
        try {
            $resource = TipoDocumento::findOrFail($id);
            return response()->json([
                'success' => true,
                'data' => $resource
            ]);
