...
use App\Models\Escalafon\IncorporacionDocumento;
use Illuminate\Http\Request;
use Illuminate\Validation\ValidationException;
use Illuminate\Support\Facades\DB;

class IncorporacionDocumentoController extends Controller
{

    public function index(Request $request)
    {
        try {    
            $query = IncorporacionDocumento::query();
    ...
    public function listarPaginado(Request $request)
    {
        try {    
            ...
            $result = IncorporacionDocumento::fromStoredProcedure(
                $filters,
                $page,
                $pageSize,
                $sortColumn,
    ...
    public function store(Request $request)
    {
        try {
            ...
            DB::beginTransaction();
            $resource = IncorporacionDocumento::create($validatedData);
            DB::commit();
    ...
    {
        try {
            $resource = IncorporacionDocumento::findOrFail($id);
            return response()->json([
                'success' => true,
                'data' => $resource
            ]);
