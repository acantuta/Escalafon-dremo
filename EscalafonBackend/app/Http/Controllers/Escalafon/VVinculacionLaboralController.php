...
class VVinculacionLaboralController extends Controller
{

    public function index(Request $request)
    {
        try {    
            $query = VVinculacionLaboral::query();
    ...
    public function listarPaginado(Request $request)
    {
        try {    
            ...
            $result = VVinculacionLaboral::fromStoredProcedure(
                $filters,
                $page,
                $pageSize,
                $sortColumn,
    ...
    public function store(Request $request)
    {
        try {
            ...
            'cVincLabCodigoPlaza' => 'nullable|string|max:10',
            ...
            'cAccVincNombre' => 'nullable|string|max:100',
            'cMotAccVincNombre' => 'nullable|string|max:100',
            'cCentLabNombre' => 'required|string|max:250',
            'cCargLabNombre' => 'nullable|string|max:150',
            'iVincLabId' => 'required|integer',
            ...
            DB::beginTransaction();
            $resource = VVinculacionLaboral::create($validatedData);
            DB::commit();
    ...
    {
        try {
            $resource = VVinculacionLaboral::findOrFail($id);
            return response()->json([
                'success' => true,
                'data' => $resource
            ]);
