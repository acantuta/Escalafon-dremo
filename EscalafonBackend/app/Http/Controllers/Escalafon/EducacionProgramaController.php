...
use App\Models\Escalafon\EducacionPrograma;
use Illuminate\Http\Request;
use Illuminate\Validation\ValidationException;
use Illuminate\Support\Facades\DB;

class EducacionProgramaController extends Controller
{

    public function index(Request $request)
    {
        try {    
            $query = EducacionPrograma::query();
    ...
    public function listarPaginado(Request $request)
    {
        try {    
            ...
            $result = EducacionPrograma::fromStoredProcedure(
                $filters,
                $page,
                $pageSize,
                $sortColumn,
    ...
    public function store(Request $request)
    {
        try {
            ...
            DB::beginTransaction();
            $resource = EducacionPrograma::create($validatedData);
            DB::commit();
    ...
    {
        try {
            $resource = EducacionPrograma::findOrFail($id);
            return response()->json([
                'success' => true,
                'data' => $resource
            ]);
