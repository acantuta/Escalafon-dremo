...
use App\Models\Escalafon\AccionVinculacion;
use Illuminate\Http\Request;
use Illuminate\Validation\ValidationException;
use Illuminate\Support\Facades\DB;

class AccionVinculacionController extends Controller
{

    public function index(Request $request)
    {
        try {    
            $query = AccionVinculacion::query();
    ...
    public function listarPaginado(Request $request)
    {
        try {    
            ...
            $result = AccionVinculacion::fromStoredProcedure(
                $filters,
                $page,
                $pageSize,
                $sortColumn,
    ...
    public function store(Request $request)
    {
        try {
            ...
            DB::beginTransaction();
            $resource = AccionVinculacion::create($validatedData);
            DB::commit();
    ...
    {
        try {
            $resource = AccionVinculacion::findOrFail($id);
            return response()->json([
                'success' => true,
                'data' => $resource
            ]);
