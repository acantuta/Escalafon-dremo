...
use App\Models\Escalafon\VacacionLicencia;
use Illuminate\Http\Request;
use Illuminate\Validation\ValidationException;
use Illuminate\Support\Facades\DB;

class VacacionLicenciaController extends Controller
{

    public function index(Request $request)
    {
        try {    
            $query = VacacionLicencia::query();
    ...
    public function listarPaginado(Request $request)
    {
        try {    
            ...
            $result = VacacionLicencia::fromStoredProcedure(
                $filters,
                $page,
                $pageSize,
                $sortColumn,
    ...
    public function store(Request $request)
    {
        try {
            ...
            DB::beginTransaction();
            $resource = VacacionLicencia::create($validatedData);
            DB::commit();
    ...
    {
        try {
            $resource = VacacionLicencia::findOrFail($id);
            return response()->json([
                'success' => true,
                'data' => $resource
            ]);
