...
use App\Models\Escalafon\InfopefamiliarDomicilio;
use Illuminate\Http\Request;
use Illuminate\Validation\ValidationException;
use Illuminate\Support\Facades\DB;

class InfopefamiliarDomicilioController extends Controller
{

    public function index(Request $request)
    {
        try {    
            $query = InfopefamiliarDomicilio::query();
    ...
    public function listarPaginado(Request $request)
    {
        try {    
            ...
            $result = InfopefamiliarDomicilio::fromStoredProcedure(
                $filters,
                $page,
                $pageSize,
                $sortColumn,
    ...
    public function store(Request $request)
    {
        try {
            ...
            DB::beginTransaction();
            $resource = InfopefamiliarDomicilio::create($validatedData);
            DB::commit();
    ...
    {
        try {
            $resource = InfopefamiliarDomicilio::findOrFail($id);
            return response()->json([
                'success' => true,
                'data' => $resource
            ]);
