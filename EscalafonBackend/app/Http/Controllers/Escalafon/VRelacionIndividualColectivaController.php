...
class VRelacionIndividualColectivaController extends Controller
{

    public function index(Request $request)
    {
        try {    
            $query = VRelacionIndividualColectiva::query();
    ...
    public function listarPaginado(Request $request)
    {
        try {    
            ...
            $result = VRelacionIndividualColectiva::fromStoredProcedure(
                $filters,
                $page,
                $pageSize,
                $sortColumn,
    ...
    public function store(Request $request)
    {
        try {
            ...
            'iRelaIndColecId' => 'required|integer',
            'iArchId' => 'required|integer',

            ]);

            DB::beginTransaction();
            $resource = VRelacionIndividualColectiva::create($validatedData);
            DB::commit();
    ...
    {
        try {
            $resource = VRelacionIndividualColectiva::findOrFail($id);
            return response()->json([
                'success' => true,
                'data' => $resource
            ]);
