...
use App\Models\Escalafon\SistemaPensionario;
...
class SistemaPensionarioController extends Controller
{
    ...
    {
        try {    
            $query = SistemaPensionario::query();
    ...
    public function listarPaginado(Request $request)
    {
        try {    
            ...
            $result = SistemaPensionario::fromStoredProcedure(
                $filters,
                $page,
                $pageSize,
                $sortColumn,
    ...
    public function store(Request $request)
    {
        try {
            ...
            DB::beginTransaction();
            $resource = SistemaPensionario::create($validatedData);
            DB::commit();
    ...
    {
        try {
            $resource = SistemaPensionario::findOrFail($id);
            return response()->json([
                'success' => true,
                'data' => $resource
            ]);
