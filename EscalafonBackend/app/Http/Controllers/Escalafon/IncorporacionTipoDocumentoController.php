...
use App\Models\Escalafon\IncorporacionTipoDocumento;
use Illuminate\Http\Request;
use Illuminate\Validation\ValidationException;
use Illuminate\Support\Facades\DB;

class IncorporacionTipoDocumentoController extends Controller
{

    public function index(Request $request)
    {
        try {    
            $query = IncorporacionTipoDocumento::query();
    ...
    public function listarPaginado(Request $request)
    {
        try {    
            ...
            $result = IncorporacionTipoDocumento::fromStoredProcedure(
                $filters,
                $page,
                $pageSize,
                $sortColumn,
    ...
    public function store(Request $request)
    {
        try {
            ...
            DB::beginTransaction();
            $resource = IncorporacionTipoDocumento::create($validatedData);
            DB::commit();
    ...
    {
        try {
            $resource = IncorporacionTipoDocumento::findOrFail($id);
            return response()->json([
                'success' => true,
                'data' => $resource
            ]);
