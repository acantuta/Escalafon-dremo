...
use App\Models\Escalafon\AdministradoraFondoPension;
use Illuminate\Http\Request;
use Illuminate\Validation\ValidationException;
use Illuminate\Support\Facades\DB;

class AdministradoraFondoPensionController extends Controller
{

    public function index(Request $request)
    {
        try {    
            $query = AdministradoraFondoPension::query();
    ...
    public function listarPaginado(Request $request)
    {
        try {    
            ...
            $result = AdministradoraFondoPension::fromStoredProcedure(
                $filters,
                $page,
                $pageSize,
                $sortColumn,
    ...
    public function store(Request $request)
    {
        try {
            ...
            DB::beginTransaction();
            $resource = AdministradoraFondoPension::create($validatedData);
            DB::commit();
    ...
    {
        try {
            $resource = AdministradoraFondoPension::findOrFail($id);
            return response()->json([
                'success' => true,
                'data' => $resource
            ]);
