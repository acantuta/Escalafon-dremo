...
use App\Models\Escalafon\ReconocimientoMerito;
use Illuminate\Http\Request;
use Illuminate\Validation\ValidationException;
use Illuminate\Support\Facades\DB;

class ReconocimientoMeritoController extends Controller
{

    public function index(Request $request)
    {
        try {    
            $query = ReconocimientoMerito::query();
    ...
    public function listarPaginado(Request $request)
    {
        try {    
            ...
            $result = ReconocimientoMerito::fromStoredProcedure(
                $filters,
                $page,
                $pageSize,
                $sortColumn,
    ...
    public function store(Request $request)
    {
        try {
            ...
            DB::beginTransaction();
            $resource = ReconocimientoMerito::create($validatedData);
            DB::commit();
    ...
    {
        try {
            $resource = ReconocimientoMerito::findOrFail($id);
            return response()->json([
                'success' => true,
                'data' => $resource
            ]);
