...
use App\Models\Escalafon\HojasVida;
...
class HojasVidaController extends Controller
{
    ...
    public function listarPaginado(Request $request)
    {
        try {    
            ...
            $result = HojasVida::fromStoredProcedure(
                $filters,
                $page,
                $pageSize,
                $sortColumn,
    ...
    public function store(Request $request)
    {
        try {
            ...
            'dHojaVidFechaGeneracionSistema' => 'nullable|date',
            ...
            DB::beginTransaction();
            $resource = HojasVida::create($validatedData);
            DB::commit();
    ...
    {
        try {
            $resource = HojasVida::findOrFail($id);
            return response()->json([
                'success' => true,
                'data' => $resource
            ]);
