...
use App\Models\Escalafon\EducacionGradoAlcanzado;
use Illuminate\Http\Request;
use Illuminate\Validation\ValidationException;
use Illuminate\Support\Facades\DB;

class EducacionGradoAlcanzadoController extends Controller
{

    public function index(Request $request)
    {
        try {    
            $query = EducacionGradoAlcanzado::query();
    ...
    public function listarPaginado(Request $request)
    {
        try {    
            ...
            $result = EducacionGradoAlcanzado::fromStoredProcedure(
                $filters,
                $page,
                $pageSize,
                $sortColumn,
    ...
    public function store(Request $request)
    {
        try {
            ...
            DB::beginTransaction();
            $resource = EducacionGradoAlcanzado::create($validatedData);
            DB::commit();
    ...
    {
        try {
            $resource = EducacionGradoAlcanzado::findOrFail($id);
            return response()->json([
                'success' => true,
                'data' => $resource
            ]);
