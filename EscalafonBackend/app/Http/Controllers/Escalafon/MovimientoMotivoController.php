...
use App\Models\Escalafon\MovimientoMotivo;
...
class MovimientoMotivoController extends Controller
{
    ...
    public function listarPaginado(Request $request)
    {
        try {    
            ...
            $result = MovimientoMotivo::fromStoredProcedure(
                $filters,
                $page,
                $pageSize,
                $sortColumn,
    ...
    public function store(Request $request)
    {
        try {
            ...
            DB::beginTransaction();
            $resource = MovimientoMotivo::create($validatedData);
            DB::commit();
    ...
    {
        try {
            $resource = MovimientoMotivo::findOrFail($id);
            return response()->json([
                'success' => true,
                'data' => $resource
            ]);
