...
use App\Models\Escalafon\RegimenLaboral;
...
class RegimenLaboralController extends Controller
{
    ...
    public function listarPaginado(Request $request)
    {
        try {    
            ...
            $result = RegimenLaboral::fromStoredProcedure(
                $filters,
                $page,
                $pageSize,
                $sortColumn,
    ...
    public function store(Request $request)
    {
        try {
            ...
            DB::beginTransaction();
            $resource = RegimenLaboral::create($validatedData);
            DB::commit();
    ...
    {
        try {
            $resource = RegimenLaboral::findOrFail($id);
            return response()->json([
                'success' => true,
                'data' => $resource
            ]);
