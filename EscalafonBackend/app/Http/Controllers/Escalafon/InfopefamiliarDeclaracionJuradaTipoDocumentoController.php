...
use App\Models\Escalafon\InfopefamiliarDeclaracionJuradaTipoDocumento;
use Illuminate\Http\Request;
use Illuminate\Validation\ValidationException;
use Illuminate\Support\Facades\DB;

class InfopefamiliarDeclaracionJuradaTipoDocumentoController extends Controller
{

    public function index(Request $request)
    {
        try {    
            $query = InfopefamiliarDeclaracionJuradaTipoDocumento::query();
    ...
    public function listarPaginado(Request $request)
    {
        try {    
            ...
            $result = InfopefamiliarDeclaracionJuradaTipoDocumento::fromStoredProcedure(
                $filters,
                $page,
                $pageSize,
                $sortColumn,
    ...
    public function store(Request $request)
    {
        try {
            ...
            DB::beginTransaction();
            $resource = InfopefamiliarDeclaracionJuradaTipoDocumento::create($validatedData);
            DB::commit();
    ...
    {
        try {
            $resource = InfopefamiliarDeclaracionJuradaTipoDocumento::findOrFail($id);
            return response()->json([
                'success' => true,
                'data' => $resource
            ]);
