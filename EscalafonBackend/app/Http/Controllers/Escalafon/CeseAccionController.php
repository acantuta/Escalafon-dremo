...
use App\Models\Escalafon\CeseAccion;
use Illuminate\Http\Request;
use Illuminate\Validation\ValidationException;
use Illuminate\Support\Facades\DB;

class CeseAccionController extends Controller
{

    public function index(Request $request)
    {
        try {    
            $query = CeseAccion::query();
    ...
    public function listarPaginado(Request $request)
    {
        try {    
            ...
            $result = CeseAccion::fromStoredProcedure(
                $filters,
                $page,
                $pageSize,
                $sortColumn,
    ...
    public function store(Request $request)
    {
        try {
            ...
            DB::beginTransaction();
            $resource = CeseAccion::create($validatedData);
            DB::commit();
    ...
    {
        try {
            $resource = CeseAccion::findOrFail($id);
            return response()->json([
                'success' => true,
                'data' => $resource
            ]);
