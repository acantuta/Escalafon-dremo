...
/**
 * Modelo para la tabla: esc.V_VacacionesLicencias
 */
class VVacacionLicencia extends Model
{
    use HasFactory;
    ...
    protected $table = 'esc.V_VacacionesLicencias'; // Esquema y tabla especificados
